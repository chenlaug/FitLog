...
public class AuthController {
    ...
    public ResponseEntity<AuthDTO.RegisterOutput> register(@RequestBody AuthDTO.RegisterInput input) {
    ...
    @PostMapping("/login")
    public ResponseEntity<AuthDTO.LoginOutput> login(@RequestBody AuthDTO.LoginInput input) {
